...
if __name__ == "__main__":
    if len(sys.argv) is not 1 + 2:
        print "usage: > python ./buil_testcorpus.py <corpus> <test corpus>"
        exit(1)

    # devel corpus files
    test_cn = open('../../tibidabo/conll_2015-10-01/test/tibidabo_test_tagsvells.conll','w')
    test_fl = open('../../tibidabo/conll_2015-10-01/test/tibidabo_test_tagsvells.fl','w')
    test_tb = open('../../tibidabo/conll_2015-10-01/test/tibidabo_test_tagsvells.tbd','w')
